...
const THEMES: Record<string, Theme> = {
  ...
  Rain: {
    ...
    accent: "#2563EB",
    decorations: [
      { type: "line", width: 4, height: 34, top: 90, left: 30, rotateDeg: 15, opacity: 0.2 },
  ...
  Snow: {
    ...
    decorations: [
      ...
      { type: "circle", size: 12, top: 180, left: 220, opacity: 0.2 },
  ...
  Clouds: {
    ...
    decorations: [
      ...
      { type: "circle", size: 220, top: 110, left: 30, opacity: 0.1 },
      { type: "circle", size: 160, top: 60, right: -50, opacity: 0.1 },
    ],
  },
  Thunderstorm: {
    background: "#EDE9FE",
...
const NIGHT_THEMES: Record<string, Theme> = {
  Clear: {
    ...
    accent: "#818CF8",
    decorations: [
      { type: "circle", size: 220, top: 40, right: -70, opacity: 0.1 },
  ...
  Snow: {
    ...
    accent: "#7DD3FC",
    decorations: [
      { type: "circle", size: 10, top: 90, left: 40, opacity: 0.2 },
